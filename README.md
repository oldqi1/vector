...
│   │   └── Private/Tests/      # Automation 测试（31 项）
...
提交前离线回归可运行：`powershell -ExecutionPolicy Bypass -File Tools/verify_prototype_offline.ps1`。它检查 31 项 Automation 注册、灰盒脚本语法、关键闭环连线与四组确定性物理模拟；UE 编译和 PIE 仍由编辑器侧完成。
